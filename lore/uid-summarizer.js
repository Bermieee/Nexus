...
function profileWritingTarget(plan,{recoveryAttempt=0}={}){const cap=Math.max(48,Number(plan?.targetTokens)||48),ratio=recoveryAttempt<=0?.78:recoveryAttempt===1?.68:.58;return Math.max(36,Math.min(cap-8,Math.floor(cap*ratio)));}
